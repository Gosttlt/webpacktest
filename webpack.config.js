...
module.exports = {
    ...
    output: {
        ...
        filename: fileName('js'), // названия файла сборки в [name] кладется ключ от точки входа [hash] используется для того, что бы при изменении контента у клиента отображались актуальные данные, а не за кешированные под одним и тем же именем
    },
